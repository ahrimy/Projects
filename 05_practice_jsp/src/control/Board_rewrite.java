...
/**
 * Servlet implementation class Board_rewrite
 */
@WebServlet("/Board_rewrite.do")
public class Board_rewrite extends HttpServlet {
	...
	protected void reqPro(HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher dis = request.getRequestDispatcher("board_rewrite.jsp");
